...
VAKANTIEVERHUUR_HITKANS_API_BASE = os.environ.get(
    "VAKANTIEVERHUUR_HITKANS_API_BASE", "http://localhost:8000"
)
VAKANTIEVERHUUR_HITKANS_AUTH_TOKEN = os.environ.get(
    "VAKANTIEVERHUUR_HITKANS_AUTH_TOKEN"
)
VAKANTIEVERHUUR_HITKANS_HEALTH_URL = os.environ.get(
    "VAKANTIEVERHUUR_HITKANS_HEALTH_URL"
)
